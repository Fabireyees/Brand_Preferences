...
library("readr")
complete<- read.csv("C:\\Respaldo FR\\UBIQUM\\Proyectos\\Brand_Preferences\\Data_sets\\CompleteResponses.csv")
incomplete<- read.csv("C:\\Respaldo FR\\UBIQUM\\Proyectos\\Brand_Preferences\\Data_sets\\SurveyIncomplete.csv")
